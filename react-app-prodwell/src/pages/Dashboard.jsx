...
export const DashboardPageContent = ({ userId, setUserId }) => {
 ...
 const fetchAIInsights = async () => {
   try {
    setisAiLoading(true);
     const response = await userService.getAIInsights(userId,sessionStorage.getItem('msal.id.token'));
     const hardcodedResponse  = JSON.parse(response.data.split('### Calculation Explanation')[0].trim());
     console.log("hardcodedResponse:",hardcodedResponse);
     ...
     setAccordData({
       ...
       suggestions: hardcodedResponse.suggestions || hardcodedResponse.analysis.suggestions ||  {
         taskManagement: [],
         personalWellbeing: [],
         counselling: [],
       },
...
{showAnalysis ? (
        isAiLoading ? (
          <div style={loaderStyle}>
            ...
            <p className="text-gray-700 text-sm" ><span className="text-blue-600 font-bold">Loading</span> your personalized  <span className="text-blue-600 font-bold">"AI insights"...</span>  This may take a moment, so thank you for your patience.</p>
          </div>
        ...
        <div className="text-gray-600">
          <p className="font-semibold text-lg">
            Click <span className="text-blue-600 font-bold">"Analyse AI "</span> to explore your stress insights and unlock actionable recommendations!
          </p>
        </div>
      )}
</div>
...
{showAnalysis && !isAiLoading && (
 <div className="w-full p-4 bg-gray-100">
   <div className="bg-white rounded-lg shadow-md p-6">
     ...
     <h3 className="text-xl font-semibold mb-4 text-gray-800">Suggestions</h3>
     <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
       {Object.entries(accordData.suggestions || {}).map(
  ...
  {category
    .replace(/([A-Z])/g, " $1") // Add spaces for camel case
